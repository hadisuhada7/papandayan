...
class ReportSubscriptionNotificationMail extends Mailable
{
     ...
     */
    public function __construct(public array $payload, public ReportSubscriber $subscriber)
    {
    ...
    {
        return new Content(
            view: 'emails.subscription_report_notification',
            with: [
                'payload' => $this->payload,
                'subscriber' => $this->subscriber,
                'unsubscribeUrl' => route('front.subscription.unsubscribe', $this->subscriber->token),
            ]
        );
    }
