...
return [
    ...
    */
    ...
    'logo' => '<b>Papandayan</b> CMS',
    'logo_img' => 'images/logo/logo5.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Sustainabilities',
            'icon' => 'fas fa-fw fa-tree',
            'submenu' => [
                [
                    'text' => 'Safety Managements',
                    'url' => 'admin/safeties',
                ],
                [
                    'text' => 'Corporate Socials',
                    'url' => 'admin/socials',
                ],
                [
                    'text' => 'Initiatives',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Shareholders',
                    'url' => 'admin/shareholders',
                ],
            ],
        ],
        [
            'text' => 'Careers',
            'icon' => 'fas fa-fw fas fa-copy',
            'submenu' => [
                [
                    'text' => 'Publish Jobs',
                    'url' => 'admin/careers',
