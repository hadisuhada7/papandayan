...
@section('title', ' Papandayan | Enable Two-Factor Authentication')
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Enable Two-Factor Authentication</li>
            </ol>
        </div>
    </div>
@stop
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        <h5><i class="icon fas fa-info-circle"></i> <strong>Steps:</strong></h5>
                        <ol>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <code style="font-size: 16px; color: red;">{{ $secret }}</code>
                    ...
                    <form action="{{ route('account.two-factor.verify') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="{{ route('account.two-factor.index') }}" class="btn btn-secondary">Back</a>
                            </div>
