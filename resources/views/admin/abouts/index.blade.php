...
@section('title', 'Papandayan | Vision & Mission')
                        ...
                        <tbody>
                            ...
                            @foreach($abouts as $about)
                                <tr>
                                    ...
                                    <td>{{ $about->name }}</td>
                                    <td>{{ $about->type }}</td>
                                    <td><img src="{{ Storage::url($about->icon) }}" alt="" style="max-width: 100px;"></td>
                                    <td><img src="{{ Storage::url($about->thumbnail) }}" alt="" style="max-width: 100px;"></td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.abouts.edit', $about) }}" class="btn btn-sm btn-primary item-edit"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $about->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.abouts.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.abouts.index') }}/" + selectedRow;
