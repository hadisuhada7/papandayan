...
@section('title', 'Papandayan | Edit Branch')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.areas.update', $area) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="partnerName" name="partner_name" value="{{ $area->partner_name }}" maxlength="255" placeholder="Branch Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control number-only" id="numberOfCages" name="number_of_cages" value="{{ $area->number_of_cages }}" maxlength="5" placeholder="Number of Farms" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="area" name="area" value="{{ $area->area }}" maxlength="255" placeholder="Regional" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control decimal-only" id="latitude" name="latitude" value="{{ $area->latitude }}" maxlength="255" placeholder="Latitude" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control decimal-only" id="longitude" name="longitude" value="{{ $area->longitude }}" maxlength="255" placeholder="Longitude" required>
