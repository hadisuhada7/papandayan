...
@section('title', 'Papandayan | Edit Article')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Article</h3>
                </div>
                <form method="POST" action="{{ route('admin.articles.update', $article) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="about" name="about" maxlength="65535" placeholder="About">{{ $article->about }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2-tags" style="width: 100%;" id="tags" name="tags[]" multiple="multiple" data-placeholder="">
                                            @foreach($tags as $tag)
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.articles.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
