                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="heading" name="heading" value="{{ old('heading') }}" maxlength="255" placeholder="Heading">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="subheading" name="subheading" maxlength="65535" placeholder="Subheading">{{ old('subheading') }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('menu_navigation_id') }}</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="link" name="link" value="{{ old('link') }}" maxlength="255" placeholder="Link">
