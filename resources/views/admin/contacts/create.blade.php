...
@section('title', 'Papandayan | Add Contact')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.contacts.store') }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="description" name="description" value="{{ old('description') }}" maxlength="255" placeholder="Description" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="otherDescription" name="other_description" value="{{ old('other_description') }}" maxlength="255" placeholder="Other Description">
