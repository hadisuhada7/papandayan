...
@section('title', 'Papandayan | Contacts')
                        ...
                        <tbody>
                            ...
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td><img src="{{ Storage::url($contact->icon) }}" alt="" style="max-width: 100px;"></td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.contacts.edit', $contact) }}" class="btn btn-sm btn-primary item-edit"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $contact->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.contacts.index') }}/" + selectedRow;
