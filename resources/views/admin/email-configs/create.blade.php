                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="host" name="host" value="{{ old('host') }}" maxlength="255" placeholder="Host" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control" id="port" name="port" value="{{ old('port', 587) }}" min="1" placeholder="Port" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="username" name="username" value="{{ old('username') }}" maxlength="255" placeholder="Username" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="password" name="password" value="{{ old('password') }}" maxlength="255" placeholder="Password" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="fromAddress" name="from_address" value="{{ old('from_address') }}" maxlength="255" placeholder="From Address" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="fromName" name="from_name" value="{{ old('from_name') }}" maxlength="255" placeholder="From Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="isActive" name="is_active" value="1" @checked(old('is_active'))>
