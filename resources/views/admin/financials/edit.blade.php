...
@section('title', 'Papandayan | Edit Financial Statement')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Financial Statement</h3>
                </div>
                <form method="POST" action="{{ route('admin.financials.update', $financial) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $financial->title }}" maxlength="255" placeholder="Title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group date" id="publishAt" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="publish_at" value="{{ $financial->publish_at ? $financial->publish_at->format('d-m-Y') : '' }}" data-target="#publishAt" placeholder="dd-MM-yyyy" required/>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.financials.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
