...
@section('title', 'Papandayan | Edit Gallery')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.galleries.update', $gallery) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $gallery->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ Storage::url($gallery->thumbnail) }}" alt="" style="max-width: 100px; margin-bottom: 15px;"> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="description" name="description" maxlength="65535" placeholder="Description" required>{{ $gallery->description }}</textarea>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.galleries.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
