...
@section('title', 'Papandayan | Edit History')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.histories.update', $history) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $history->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group date" id="historyAt" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="track_record_at" value="{{ $history->track_record_at ? $history->track_record_at->format('d-m-Y') : '' }}" data-target="#historyAt" placeholder="dd-MM-yyyy" required/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="description" name="description" maxlength="65535" placeholder="Description" required>{{ $history->description }}</textarea>
