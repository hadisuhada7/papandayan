...
@section('title', 'Papandayan | Add Investor Presentation')
...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Add Investor Presentation</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.investors.store') }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="card-body">
