...
@section('title', 'Papandayan | Edit Menu Navigation')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.navigations.update', $navigation) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $navigation->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="url" name="url" value="{{ $navigation->url }}" maxlength="255" placeholder="URL" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-switch" style="margin-top: 7px;">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="isActive" value="true" name="is_active" {{ old('is_active', $navigation->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="icon" name="icon" value="{{ $navigation->icon }}" maxlength="255" placeholder="Icon (e.g. fas fa-home)">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="icon-preview">
                                                    <i class="{{ old('icon', $navigation->icon ?: 'fas fa-question') }}"></i>
                                                </span>
                                            </div>
                                        </div>
