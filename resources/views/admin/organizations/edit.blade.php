...
@section('title', 'Papandayan | Edit Organization')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Organization</h3>
                </div>
                <form method="POST" action="{{ route('admin.organizations.update', $organization) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $organization->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ Storage::url($organization->thumbnail) }}" alt="" style="max-width: 100px; margin-bottom: 15px;"> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="description" name="description" maxlength="65535" placeholder="Description" required>{{ $organization->description }}</textarea>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.organizations.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
