...
@section('title', 'Papandayan | Organization Structures')
                        ...
                        <tbody>
                            ...
                            @foreach($organizations as $organization)
                                <tr>
                                    ...
                                    <td><img src="{{ Storage::url($organization->thumbnail) }}" alt="" style="max-width: 100px;"></td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.organizations.edit', $organization) }}" class="btn btn-sm btn-primary item-edit"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $organization->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.organizations.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.organizations.index') }}/" + selectedRow;
