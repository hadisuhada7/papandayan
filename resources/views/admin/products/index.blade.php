...
@section('title', 'Papandayan | Products')
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $product->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.products.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.products.index') }}/" + selectedRow;
