...
@section('title', 'Papandayan | Edit Profile')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.profiles.update', $profile) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $profile->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ Storage::url($profile->thumbnail) }}" alt="" style="max-width: 100px; margin-bottom: 15px;"> 
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.profiles.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
