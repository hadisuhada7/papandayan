        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Annual Report</h3>
                </div>
                <form method="POST" action="{{ route('admin.reports.update', $report) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $report->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ Storage::url($report->thumbnail) }}" alt="" style="max-width: 100px; margin-bottom: 15px;"> 
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.reports.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
