...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Edit Safety Management</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.safeties.index') }}">Safety Managements</a></li>
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Safety Management</h3>
                </div>
                <form method="POST" action="{{ route('admin.safeties.update', $safety) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $safety->title }}" maxlength="255" placeholder="Title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="about" name="about" maxlength="65535" placeholder="About">{{ $safety->about }}</textarea>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.safeties.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
