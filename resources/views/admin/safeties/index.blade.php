...
@section('title', 'Papandayan | Safety Managements')
...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Safety Managements</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Safety Managements</li>
            </ol>
        </div>
    </div>
@stop
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.safeties.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.safeties.index') }}/" + selectedRow;
