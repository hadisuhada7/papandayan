...
@section('title', 'Papandayan | Edit Corporate Social')
...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Edit Corporate Social</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.socials.index') }}">Corporate Socials</a></li>
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Corporate Social</h3>
                </div>
                <form method="POST" action="{{ route('admin.socials.update', $social) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $social->title }}" maxlength="255" placeholder="Title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="subtitle" name="subtitle" maxlength="65535" placeholder="Subtitle"  required>{{ $social->subtitle }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="author" name="author" value="{{ $social->author }}" maxlength="255" placeholder="Author" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group date" id="publishAt" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="publish_at" value="{{ $social->publish_at ? $social->publish_at->format('d-m-Y') : '' }}" data-target="#publishAt" placeholder="dd-MM-yyyy" required/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ Storage::url($social->thumbnail) }}" alt="" style="max-width: 100px; margin-bottom: 15px;"> 
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.socials.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
