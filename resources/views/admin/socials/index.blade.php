...
@section('title', 'Papandayan | Corporate Socials')
...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Corporate Socials</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Corporate Socials</li>
            </ol>
        </div>
    </div>
@stop
                            ...
                            @foreach($socials as $social)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $social->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.socials.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.socials.index') }}/" + selectedRow;
