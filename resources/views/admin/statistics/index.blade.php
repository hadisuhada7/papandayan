...
@section('title', 'Papandayan | Company Statistics')
                        ...
                        <tbody>
                            ...
                            @foreach($statistics as $statistic)
                                <tr>
                                    ...
                                    <td><img src="{{ Storage::url($statistic->icon) }}" alt="" style="max-width: 100px;"></td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.statistics.edit', $statistic) }}" class="btn btn-sm btn-primary item-edit"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $statistic->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.statistics.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.statistics.index') }}/" + selectedRow;
