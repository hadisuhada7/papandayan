...
@section('title', 'Papandayan | Edit Stock Information')
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.stocks.index') }}">Stock Informations</a></li>
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Stock Information</h3>
                </div>
                <form method="POST" action="{{ route('admin.stocks.update', $stock) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $stock->title }}" maxlength="255" placeholder="Title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group date" id="publishAt" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="publish_at" value="{{ $stock->publish_at ? $stock->publish_at->format('d-m-Y') : '' }}" data-target="#publishAt" placeholder="dd-MM-yyyy" required/>
                                ...
                                @php 
                                    $i = 0; 
                                @endphp
                                @forelse ($stock->stockReports as $report)
                                    <div class="form-group row">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.stocks.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
