...
@section('title', 'Papandayan | Edit Testimonial')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.testimonials.update', $testimonial) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $testimonial->name }}" maxlength="255" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="occupation" name="occupation" value="{{ $testimonial->occupation }}" maxlength="255" placeholder="Occupation" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ Storage::url($testimonial->avatar) }}" alt="" style="max-width: 100px; margin-bottom: 15px;"> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="message" name="message" maxlength="65535" placeholder="Message" required>{{ $testimonial->message }}</textarea>
