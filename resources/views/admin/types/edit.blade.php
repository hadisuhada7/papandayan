...
@section('title', 'Papandayan | Edit Type')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.types.update', $type) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $type->name }}" maxlength="255" placeholder="Name" required>
