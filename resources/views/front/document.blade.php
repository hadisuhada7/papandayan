...
@push('after-scripts')
    <script>
        $(document).ready(function () {
            console.log('=== Document ready - Modal download initialized ===');
            ...
            $(document).on("click", ".item-download", function(e){
                ...
                selectedDocumentName = $(this).closest('.latestNewsCardInner').find('.latestNewsTxt h4 a').text();
                
                console.log('Download clicked - ID:', selectedDocumentId, 'Name:', selectedDocumentName);
                
                $("#document-name").text(selectedDocumentName);
            ...
            $(document).on("click", "#btn-modal-download", function(e){
                ...
                if(!selectedDocumentId) {
                    console.error('ERROR: No document ID');
                ...
                // Build URL
                var submitUrl = "{{ route('front.document.download.with.log', ':id') }}".replace(':id', selectedDocumentId);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Trigger download
                        var downloadUrl = "{{ route('front.document.download', ':id') }}".replace(':id', selectedDocumentId);
