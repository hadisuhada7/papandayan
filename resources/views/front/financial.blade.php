   ...
   <section class="w-100 clearfix blogArticles blogPg" id="blogArticles">
      <div class="container">
         <div class="blogArticlesInner">
            ...
            {{ $financials->links('front.partials.pagination') }}
         </div>
      </div>
   </section>
   <!--blog section end-->
      ...
      $(function () {
         ...
         $form.validate({
            ...
            submitHandler: function () {
               ...
               const submitUrl = "{{ route('front.financial.download.with.log', ':id') }}".replace(':id', selectedReport.id);
               ...
               $.ajax({
                  ...
                  $modal.modal('hide');
                  Toast.success('Download laporan keuangan dimulai...');

                  const downloadUrl = "{{ route('front.financial.download', ':id') }}".replace(':id', selectedReport.id);
