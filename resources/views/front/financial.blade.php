       ...
       <div class="modal-dialog modal-md" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   <h4 class="modal-title">Download Laporan Keuangan</h4>
                   ...
                   <form id="download-form">
                       ...
                       <div class="row">
                           <div class="col-12">
                               ...
                               <div class="form-group row">
                                   <label for="document" class="col-sm-3 col-form-label">Laporan</label>
                                   <div class="col-sm-9">
...
@push('after-scripts')
   <script>
      $(document).ready(function () {
          console.log('=== Financial report download modal initialized ===');
          ...
          $(document).on("click", "#btn-modal-download", function(e){
              ...
              // Build URL - menggunakan route financial report
              var submitUrl = "{{ route('front.financial.download.with.log', ':id') }}".replace(':id', selectedReportId);
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      // Trigger download
                      var downloadUrl = "{{ route('front.financial.download', ':id') }}".replace(':id', selectedReportId);
