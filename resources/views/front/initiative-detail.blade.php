                                        ...
                                        <div class="shareGroup">
                                            <ul class="nav">
                                                ...
                                                <li class="nav-item shareSocialIcon">
                                                    ...
                                                    <a class="nav-link" href="https://x.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($initiative->title) }}" target="_blank" rel="noopener noreferrer"><img src="{{ asset('images/icon/twitter.png') }}" alt="twitter" class="img-fluid"></a>
