                                        ...
                                        <div class="latestNewsCardInner mb-4 fadein">
                                            ...
                                            <div class="latestNewsCardInnerContent">
                                                ...
                                                <div class="latestNewsTxt">
                                                    <h4><a href="{{ route('front.initiative-detail', $initiative->slug) }}">{{ $initiative->title }}</a></h4>
                                                    <p>{{ $initiative->subtitle }}</p>
                                                </div>
                                                <div class="latestNewBtn">
                                                    <a class="btnCustom2 btn-1 hover-slide-down" href="{{ route('front.initiative-detail', $initiative->slug) }}">
