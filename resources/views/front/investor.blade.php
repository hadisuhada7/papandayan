   ...
   <section class="w-100 clearfix bannerSec" id="bannerSec" style="background-image: url('{{ asset('images/inner-banner.png') }}');">
      <div class="container">
         <div class="bannerContent">
            <h1>Presentasi Investor</h1>
            <ul class="breadcrumb">
               <li class="breadcrumb-item"><a href="{{ route('front.index') }}">Beranda</a></li>
               <li class="breadcrumb-item active">Presentasi Investor</li>
            </ul>
         </div>
      </div>
   </section>
...
@push('after-scripts')
   <script>
      $(document).ready(function () {
          console.log('=== Investor presentation download modal initialized ===');
          ...
          $(document).on("click", "#btn-modal-download", function(e){
              ...
              if(!selectedReportId) {
                  ...
                  alert('Error: Tidak ada presentasi yang dipilih');
                  return;
              }
              ...
              // Build URL - menggunakan route investor report
              var submitUrl = "{{ route('front.investor.download.with.log', ':id') }}".replace(':id', selectedReportId);
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      // Trigger download
                      var downloadUrl = "{{ route('front.investor.download', ':id') }}".replace(':id', selectedReportId);
