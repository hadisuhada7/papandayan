            ...
            <div class="searchFormPanel">
                <form action="{{ route('front.search') }}" method="GET">
                    <div class="input-group">
                        <input type="text" class="form-control" name="q" value="{{ $query }}" placeholder="Search" aria-label="Masukkan kata kunci pencarian" required>
                        <button type="submit" class="btnSearchAction">Search</button>
                    </div>
                </form>
                ...
                @if(!empty($quickSearchTerms))
                    <div class="searchChips">
                        ...
                        @foreach($quickSearchTerms as $term)
                            @php 
                                $queryValue = $term['query'] ?? $term['label']; 
                            @endphp
