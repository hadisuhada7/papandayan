    ...
    <div class="breadcrumb">
        <div class="container">
            <ul>
                ...
                <li><a href="javascript:void(0);">Hubungan Investor</a></li>
                <li><a>RUPS</a></li>
            </ul>
        </div>
    </div>
    ...
    <section class="w-100 clearfix blogArticles blogPg" id="blogArticles">
        <div class="container">
            <div class="blogArticlesInner">
                    ...
                    <div class="row blogWithSidebarRow">
                        ...
                        @forelse ($shareholders as $shareholder)
                            <div class="col-md-12 col-lg-12 blogWithSidebarCol">
                                <div class="latestNewsCardInner mb-4 fadein file-list">
                                    <div class="list">
                                        <div class="list-date"> 
                                            <h6>{{ $shareholder->publish_at->locale('id')->isoFormat('DD MMMM Y') }}</h6> 
                                        </div>
                ...
                {{ $shareholders->links('front.partials.pagination') }}
        ...
        $(function () {
            ...
            $form.validate({
                ...
                submitHandler: function () {
                    ...
                    const submitUrl = "{{ route('front.shareholder.download.with.log', ':id') }}".replace(':id', selectedReport.id);
                    ...
                    $.ajax({
                        ...
                        const downloadUrl = "{{ route('front.shareholder.download', ':id') }}".replace(':id', selectedReport.id);
