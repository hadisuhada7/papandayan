...
@section('title', 'Informasi Saham & Obligasi')
    ...
    <div class="breadcrumb">
        <div class="container">
            <ul>
                ...
                <li><a>Informasi Saham & Obligasi</a></li>
            </ul>
        </div>
    </div>
    <!--breadcrumb end-->
    ...
    <section class="w-100 clearfix blogArticles blogPg" id="blogArticles">
        <div class="container">
            <div class="blogArticlesInner">
                        ...
                        @forelse ($stocks as $stock)
                            <div class="col-md-12 col-lg-12 blogWithSidebarCol">
                                <div class="latestNewsCardInner mb-4 fadein file-list">
                                    <div class="list">
                                        <div class="list-date"> 
                                            <h6>{{ $stock->publish_at->locale('id')->isoFormat('DD MMMM Y') }}</h6> 
                                        </div>
                ...
                {{ $stocks->links('front.partials.pagination') }}
